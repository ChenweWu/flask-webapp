...
def predictX(data):
    ...
    def get_shap_values_plot_path(model, X,pred):
        ...
        cols =  ['X_disp_max_1', 'X_disp_min_1', 'X_disp_mean_1', 'X_disp_std_1', 'X_disp_rms_1', 'X_disp_skew_1', 'X_disp_kurtosis_1', 
                 'X_disp_crest_factor_1', 'X_disp_form_factor_1', 'X_disp_median_1', 'X_disp_variance_1', 'X_disp_iqr_1',
                   'Y_disp_max_1', 'Y_disp_min_1', 'Y_disp_mean_1', 'Y_disp_std_1', 'Y_disp_rms_1', 'Y_disp_skew_1', 'Y_disp_kurtosis_1', 
                   'Y_disp_crest_factor_1', 'Y_disp_form_factor_1', 'Y_disp_median_1', 'Y_disp_variance_1', 'Y_disp_iqr_1', 'Z_disp_max_1', 
                   'Z_disp_min_1', 'Z_disp_mean_1', 'Z_disp_std_1', 'Z_disp_rms_1', 'Z_disp_skew_1', 'Z_disp_kurtosis_1', 'Z_disp_crest_factor_1',
                     'Z_disp_form_factor_1', 'Z_disp_median_1', 'Z_disp_variance_1', 'Z_disp_iqr_1', 'X_speed_max_1', 'X_speed_min_1', 'X_speed_mean_1',
                       'X_speed_std_1', 'X_speed_rms_1', 'X_speed_skew_1', 'X_speed_kurtosis_1', 'X_speed_crest_factor_1', 'X_speed_form_factor_1', 
                     'X_speed_median_1', 'X_speed_variance_1', 'X_speed_iqr_1', 'Y_speed_max_1', 'Y_speed_min_1', 'Y_speed_mean_1', 'Y_speed_std_1', 
                     'Y_speed_rms_1', 'Y_speed_skew_1', 'Y_speed_kurtosis_1', 'Y_speed_crest_factor_1', 'Y_speed_form_factor_1', 'Y_speed_median_1', 
                     'Y_speed_variance_1', 'Y_speed_iqr_1', 'Z_speed_max_1', 'Z_speed_min_1', 'Z_speed_mean_1', 'Z_speed_std_1', 'Z_speed_rms_1', 
                     'Z_speed_skew_1', 'Z_speed_kurtosis_1', 'Z_speed_crest_factor_1', 'Z_speed_form_factor_1', 'Z_speed_median_1', 'Z_speed_variance_1',
                       'Z_speed_iqr_1', 'X_disp_max_2', 'X_disp_min_2', 'X_disp_mean_2', 'X_disp_std_2', 'X_disp_rms_2', 'X_disp_skew_2', 'X_disp_kurtosis_2',
                         'X_disp_crest_factor_2', 'X_disp_form_factor_2', 'X_disp_median_2', 'X_disp_variance_2', 'X_disp_iqr_2', 'Y_disp_max_2',
                         'Y_disp_min_2', 'Y_disp_mean_2', 'Y_disp_std_2', 'Y_disp_rms_2', 'Y_disp_skew_2', 'Y_disp_kurtosis_2', 'Y_disp_crest_factor_2', 
                         'Y_disp_form_factor_2', 'Y_disp_median_2', 'Y_disp_variance_2', 'Y_disp_iqr_2', 'Z_disp_max_2', 'Z_disp_min_2', 
                         'Z_disp_mean_2', 'Z_disp_std_2', 'Z_disp_rms_2', 'Z_disp_skew_2', 'Z_disp_kurtosis_2', 'Z_disp_crest_factor_2',
                           'Z_disp_form_factor_2', 'Z_disp_median_2', 'Z_disp_variance_2', 'Z_disp_iqr_2', 'X_speed_max_2', 'X_speed_min_2',
                             'X_speed_mean_2', 'X_speed_std_2', 'X_speed_rms_2', 'X_speed_skew_2', 'X_speed_kurtosis_2', 'X_speed_crest_factor_2',
                               'X_speed_form_factor_2', 'X_speed_median_2', 'X_speed_variance_2', 'X_speed_iqr_2', 'Y_speed_max_2', 'Y_speed_min_2', 
                               'Y_speed_mean_2', 'Y_speed_std_2', 'Y_speed_rms_2', 'Y_speed_skew_2', 'Y_speed_kurtosis_2', 'Y_speed_crest_factor_2', 
                               'Y_speed_form_factor_2', 'Y_speed_median_2', 'Y_speed_variance_2', 'Y_speed_iqr_2', 'Z_speed_max_2', 'Z_speed_min_2',
                                 'Z_speed_mean_2', 'Z_speed_std_2', 'Z_speed_rms_2', 'Z_speed_skew_2', 'Z_speed_kurtosis_2', 'Z_speed_crest_factor_2', 
                                 'Z_speed_form_factor_2', 'Z_speed_median_2', 'Z_speed_variance_2', 'Z_speed_iqr_2']
